 ...
 */
/**
 * InCardUserGetEvent.  从卡券进入公众号会话事件推送
 * 
 * @author Muarine <maoyun@rtmap.com>
 * @date   2016年3月25日
 * @since 1.0.0
 */
public class InCardUserEnterSessionEvent extends EventInMsg{
     ...
     * @param event
     */
    public InCardUserEnterSessionEvent(String toUserName, String fromUserName, Integer createTime, String msgType,
            String event) {
