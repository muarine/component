...
import com.rtmap.wx.sdk.mp.out.OutImageMsg;
import com.rtmap.wx.sdk.mp.out.OutMsg;
import com.rtmap.wx.sdk.mp.out.OutMusicMsg;
import com.rtmap.wx.sdk.mp.out.OutNewsMsg;
import com.rtmap.wx.sdk.mp.out.OutTextMsg;
import com.rtmap.wx.sdk.mp.out.OutVideoMsg;
import com.rtmap.wx.sdk.mp.out.OutVoiceMsg;
...
/**
 * 
 * OutMsgXmlBuilder. 利用 FreeMarker 动态生成 OutMsg xml 内容
 * 
 * @author muarine
 * @since 2.1.6
 */
